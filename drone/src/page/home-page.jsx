        ...
        <div>
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center lg:justify-evenly justify-center mt-10">
            <iframe
              ...
              allowfullscreen
            ></iframe>
            <div className="text-white lg:w-[600px] w-[350px] text-sm lg:text-[14px] flex flex-col gap-10">
              <div className="border-b">
                <h1 className="text-[#FE390C]">СЕЛЬСКОЕ ХОЗЯЙСТВО</h1>
                <div className="flex justify-between f-full">
                  <p className="text-[12px]">
                    Данный модель дрона многофункциональна и проста в
                    использовании. Оно сэкономит ваше время и силы.
                  </p>
                  <NavLink
                    to="/service"
                    className="text-[10px] text-[#FE390C] flex items-center gap-1"
                  >
                    Подробнее <AiOutlineForward />
                  </NavLink>
                </div>
              </div>
              <div className="border-b">
                ...
                <div className="flex justify-between w-full">
                  <p className="text-[12px]">
                    Мониторинг сотовой вышки, мониторинг строительства, Карьеры,
              ...
              <div className="border-b">
                ...
                <div className="flex justif-between w-full">
                  <p className="text-[12px]">
                    Дроны в спасательных операциях уже не редкость. Но не все
                    могут работать объективно и точно.
                  </p>
                  <NavLink
                    to="/service"
                    className="text-[10px] text-[#FE390C] flex items-center gap-1"
